...
///
/// The view observes a `GrandArtDocument` object and binds to `requiresFullCalc` and `showGradient`
...
///
/// The view dynamically updates based on changes in the `GrandArtDocument`.
///  It can show either a gradient representation between two adjacent colors or a fully calculated Mandelbrot set
/// image.
///
/// - Parameters:
///   - doc: An observed `GrandArtDocument` object containing image and calculation data.
