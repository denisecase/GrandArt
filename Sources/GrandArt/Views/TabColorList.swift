...
/// It displays a list of colors (`hues`) from a `GrandArtDocument` object. Each hue is represented by a
/// `TabColorListRow`.
/// The list allows for reordering of colors, which is handled by the `moveHues(from:to:)` function.
///
/// - Parameters:
///   - doc: An `ObservedObject` of type `GrandArtDocument`. This is the document model containing the data.
...
struct TabColorList: View {
  ...
  ///
  /// When hues are moved in the list, this function updates their order in the `GrandArtDocument`.
