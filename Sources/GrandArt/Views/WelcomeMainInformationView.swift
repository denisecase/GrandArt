...
struct WelcomeMainInformationView: View {
  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 10) {
      Text("GrandArt is the ultimate app for creating custom art from variations on the Mandelbrot set.")
        .font(.title3)
      ...
      Button(action: {
        ...
        NSDocumentController.shared.newDocument("new.grandart")
      }) {
        Text("Click here to open default GrandArt document and get started")
          .fontWeight(.semibold)
      }
