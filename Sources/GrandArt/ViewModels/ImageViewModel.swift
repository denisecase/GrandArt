...
class ImageViewModel: ObservableObject {
  @Published var doc: GrandArtDocument
  ...
  /// A computed property for managing a cached GrandArt image.
  ...
  /// - Parameters:
  ///   - doc: A `GrandArtDocument` instance containing the image details.
  ...
  init(doc: GrandArtDocument, requiresFullCalc: Binding<Bool>, showGradient: Binding<Bool>) {
    self.doc = doc
