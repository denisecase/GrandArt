...
/// `GrandArtApp` is the main structure for the SwiftUI app.
/// It defines the behavior and layout of the app.
@available(macOS 12.0, *)
@main
struct GrandArtApp: App {
  @StateObject private var defaultDocument = GrandArtDocument()
...
//          }
    ...
    DocumentGroup(newDocument: { GrandArtDocument() }) { file in
