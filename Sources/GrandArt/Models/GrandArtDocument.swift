/**
 GrandArtDocument is a reference file document that supports only reading and writing GrandArt data files that generate GrandArt pictures.
 ...
 property for the name of the data document and a simple initializer that creates a new demo GrandArt.
...
/**
 ...
 Note: Since GrandArtDocument is a class,  derive from [ReferenceFileDocument](
 https://developer.apple.com/documentation/swiftui/referencefiledocument
 )
 rather than FileDocument for a struct.
 */
@available(macOS 12.0, *)
final class GrandArtDocument: ReferenceFileDocument, ObservableObject {
  ...
  static var readableContentTypes: [UTType] { [.grandartDocType] }
