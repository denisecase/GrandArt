/**
 ...
 This class is used to manage the user inputs needed to create a project.

 Overview

 The PictureDefinition class provides a simple structure to manage
 the definition of one instance of GrandArt.
 ...
 in each document-driven GrandArt window.
...
// The user input information defining a GrandArt picture.
@available(macOS 12.0, *)
struct PictureDefinition: Codable, Identifiable {
  var id = UUID()
  var xCenter: Double = 0.0 // start in center
  var yCenter: Double = 0.0
  var scale: Double = 430.0
  var iterationsMax: Double = 1000.0 // start w/less
