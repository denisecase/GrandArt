/**
 ...
 This class is used to manage one color or hue entry in the project.
...
/**
 Represents a sorted color used in the project.

 Each `Hue` instance manages a single color with its RGB components and a corresponding SwiftUI `Color` object.
 It's used for sorting, encoding/decoding, and UI updates within the project.
